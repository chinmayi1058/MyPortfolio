      ...
      <Container className="main-cont text-white">
        <Row>
          <Col md={6} sm={12}>
            <Row className="m-auto text-center ">
              ...
              <Col md={8} xs={8} className="pb-2">
                <h3 className="header pt-3 float-left">Chinmayi Alshetty</h3>
              </Col>
              {/* <Col>
          ...
          <Col md={5} sm={12} className="text-center">
            ...
            <a className="text-white-50 text-decoration-none" href="#About">
              About
            </a>
            <br />
            <a className="text-white-50 text-decoration-none" href="#Skills">
              Skills
            </a>
            <br />
            <a className="text-white-50 text-decoration-none" href="#Projects">
              Projects
            </a>
            <br />
            <a className="text-white-50 text-decoration-none" href="#Contact">
              Contact
            </a>
          </Col>
        </Row>
