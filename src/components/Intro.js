  ...
  return (
    <section id="Home">
      <Container fluid className="view p-0">
        <Particles options={options} className="tparticle" />
            ...
            <Row>
              <div className="zIndex2 mb-4 white-text text-center">
                <FadeIn transitionDuration={3000}>
                  <h1 className="nameHeader display-1">Chinmayi Alshetty</h1>
                  <hr className="hr-light m-auto w-50" />
                  <h4 className="fst-italic mt-4 mb-4 ml-2 mr-2">
                    A computer science student Enthusiastic about technology.
                  </h4>
                  <a
                    href="#Projects"
                    rel="noreferrer"
